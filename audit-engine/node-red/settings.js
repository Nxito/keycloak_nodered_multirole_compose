...
module.exports = {
   ...
   //          username: 'admin',
   //          password:
   //             '$2a$08$4qO3wYa8SlHN4/JZFjohLuEftZJEk6OgxzblkU5hhF847pA1uaeD6',
   //          permissions: '*',
   //       },
   //    ],
   // },
   ...
   functionGlobalContext: {
      ...
      // spotify_playlist_dl: require("spotify-playlist-downloader"),
   ...
   editorTheme: {
      ...
      header: {
         title: 'Local - Engine',
         image: __dirname + '/static/logos/tds1400trans.png', // or null to remove image
         url: 'http://www.tecdesoft.es/', // optional url to make the header text/image a link to this url
      },
      projects: {
